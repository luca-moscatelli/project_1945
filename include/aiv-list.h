...
int  aiv_list_size(alist*);//ok
void*   aiv_list_item_at(alist*, int index);//ok
boolean aiv_list_set(alist*, void *elem, int index);//ok
void    aiv_list_add(alist*, void *elem);//ok
void    aiv_list_add_at(alist*, void *data, int index);//ok
void    aiv_list_destroy(alist*);//ok
void    aiv_list_remove(alist*, void* data);//ok
void    aiv_list_remote_at(alist*, int index);//ok
