...
void *aiv_list_item_at(alist *list, int index)
{
    alnode *node = list->__head;
...
boolean aiv_list_set(alist *list, void *data, int index)
{
    alnode *node = list->__head;
...
void aiv_list_add_at(alist *list, void *data, int index)
{
    alnode *node = list->__head;
...
void aiv_list_remote_at(alist *list, int index)
{
    alnode *node = list->__head;
